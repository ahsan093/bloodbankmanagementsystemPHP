...
EMPLOYEE NAME:<input type="text" name="name" value=""/><br></br>
EMPLOYEE ID:<input type="integer" name="id" value=""/><br></br>
EMPLOYEE ADDRESS:<input type="text" name="address" value=""/><br></br>
EMPLOYEE CONTACT NUMBER:<input type="integer" name="contact" value=""/><br></br>
EMPLOYEE DESIGNATION:<input type="text" name="designation" value=""/><br></br>
EMPLOYEE SALARY:<input type="integer" name="salary" value=""/><br></br>
...
if($_GET['submit'])
{
	...
	if($name!="" && $id!="" && $address!=""  && $contact!="" && $designation!="" && $salary!="")
	{
		$query="INSERT INTO employee VALUES('$name','$id','$address','$contact','$designation','$salary')";
