...
<form class="example" action="procedures.php" method="">
  <input type="text" placeholder="Search by name" name="SEARCH">
  <button type="submit"><i class="fa fa-search"></i></button>
</form>
<ul>
  <li><a href="einsert.php">ENROLL A NEW EMPLOYEE</a></li>
</ul>
&nbsp
<ul>
  <li><a href="edisplay.php">DISPLAY EMPLOYEE'S DATA</a></li>
</ul>
&nbsp
<ul>
  <li><a href="edisplay.php">UPDATE EMPLOYEE'S RECORD</a></li>
</ul>
&nbsp
<ul>
  <li><a href="edisplay.php">DELETE EMPLOYEE'S RECORD</a></li>
</ul>
</body>
</html>