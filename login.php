			...
			<div class="wrap-login100">
				...
				<form class="login100-form validate-form" method="post">
					...
					<div class="container-login100-form-btn">
						<input type="submit"  name="submit" value="LOGIN"class="login100-form-btn" type="submit">
					...
					<div class="text-center p-t-12">
						...
						<a class="txt1" href="signup.php" name="submit1">
...
<!--===============================================================================================-->
  ...
  <div class="container px-5 py-8 mx-auto flex items-center sm:flex-row flex-col">
    <a class="flex title-font font-medium items-center md:justify-start justify-center text-white">
      ...
      <span class="ml-3 text-xl">BLOOD DONORS PAKISTAN</span>
    </a>
    <p class="text-sm text-gray-600 sm:ml-4 sm:pl-4 sm:border-l-2 sm:border-gray-800 sm:py-2 sm:mt-0 mt-4">© 2020 BLOODDONORSPAKISTAN —
      <a href="https://twitter.com/cbstian197" class="text-gray-500 ml-1" target="_blank" rel="noopener noreferrer">@bdpk</a>
    </p>
...
if(isset($_POST['submit']))
	...
	/*if($total!=1)
	{
		echo "LOGIN FAILED! PLEASE ENTER CORRECT LOGIN CREDENTIALS";
	}*/
?>
